package org.kesler.pvdstat.local.gui;
...
public abstract class AbstractController {
    ...
    public void showMain(Stage stage, String title, Image icon, int width, int hight) {
        log.info("Show Main with title " + title + " and icon");
        this.stage = stage;
        if (scene==null) scene = new Scene(root, width, hight);
