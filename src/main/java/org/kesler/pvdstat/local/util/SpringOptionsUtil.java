...
public abstract class SpringOptionsUtil {
    ...
    public static Properties loadOptions() {
        ...
        String configFilePath = FileUtils.getJarPath()+"config"+ File.separator+"PVDStat-local.properties";
    ...
    public static void saveOptions(Properties options) {
        ...
        String configFilePath = configDirPath + "PVDStat-local.properties";
    ...
    public static Properties getDefaultOptions() {
        ...
        properties.setProperty("pvd.ip","127.0.0.1");
        properties.setProperty("pvd.books","");
        properties.setProperty("app.branch","");
